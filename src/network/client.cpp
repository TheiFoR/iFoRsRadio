...
void Client::registrationSubscribe()
{
    ...
    emit subscribe(api::server::ServerConnectionResponse::__name__, this, std::bind(&Client::handleServerConnectionStatus, this, std::placeholders::_1), SubscriptionNode::SubscriptionType::SelfHandle);
